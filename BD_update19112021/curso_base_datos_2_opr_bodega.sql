...
CREATE TABLE `opr_bodega` (
  `id_bodega` int(255) NOT NULL AUTO_INCREMENT COMMENT 'identificador de la bodega',
  `descripcion` varchar(75) NOT NULL COMMENT 'nombre de la bodega',
...
INSERT INTO `opr_bodega` VALUES (1,'Bodega Principal','A'),(2,'Bodega de Consignacion','A');
